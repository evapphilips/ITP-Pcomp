...
void loop() {
  ...
  // button output
      ...
      if(clearButtonState == LOW){ // set buttons to true if pressed
        Serial.println("0010");
      }
      if(submitButtonState == LOW){ // set buttons to true if pressed
        Serial.println("0001");
      }
}
...
myString = myString + buffer[i];
 ...
 // Serial.print(myString);
  ...
  if(myString == "8720921438"){
    ...
    Serial.print('V');
  }else if(myString == "112311799"){
    Serial.print('W');
  }else if(myString == "22869218217"){
    Serial.print('X');
  }else if(myString == "21823711699"){
    Serial.print('Y');
  }else if(myString == "2341219217"){
    Serial.print('Z');
  }
}
